...
local repositoryURL = "https://raw.githubusercontent.com/vberezinbadger/mineOS/master/"
...
local installerMenu = menu:addContextMenuItem("mineOS Setup Wizard", 0x2D2D2D)
